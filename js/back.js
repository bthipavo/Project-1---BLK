...
// app.params('getSearchText', function(req, res, next, getSearchText){
// 	console.log('found search text' + req.query.getSearchText);
// });
...
app.get('/search', function (req, res) {
    ...
    client.games({
        ...
        'first_release_date', 'release_dates.date', 'popularity', 'url', 'category', 'screenshots', 'videos'], // Return all fields
...
app.get('/', function (req, res) {
    ...
    client.games({
        fields: ['name', 'total_rating', 'aggregated_rating', 'first_release_date', 'release_dates.date'], // Return all fields
        limit: 10, // Limit to 5 results
        offset: 15, // Index offset for results
        // search: 'zelda',
        filters: { 
        	'aggregated_rating-gte' : '80',
        'release_dates.date-gt': '2016-12-31',
